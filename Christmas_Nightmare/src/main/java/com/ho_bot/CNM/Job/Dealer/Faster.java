...
public class Faster extends Job
{
    ...
    private void leftAction(Player player)
    {
    	if(CoolTimeUtil.ShootCheck(player)) {
    		...
    		ShootUtility.ShootGunSpreadShoot(player, Particle.CRIT, 30, 1.0F, 3, 0.0D, 0.0D, 0.0D, 0.0D, 1, Sound.ENTITY_GENERIC_EXPLODE, 1.0F, 1.0F, 5, 9);
    	}
    }
