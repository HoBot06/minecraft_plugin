...
public class WordVar {
    ...
    public static final String Krampus = "크람푸스";
    public static final String NoTeam = "white";
    public static final String TeamShowName = "팀표시이름";
    ...
    public static final String Boots_Up = ChatColor.GRAY + "신발강화";
}
