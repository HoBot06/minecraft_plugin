	...
	public void run()
	{
		...
		if (count%75 == 0)
		{
			...
			case 375:
				...
				Bukkit.broadcastMessage("원활한 게임 플레이를 위해 버킷 최신버전을 사용해주세요");
			...
			case 450:
				...
				Bukkit.broadcastMessage("몇몇 능력은 자신의 위치에 아이템이 떨어지는 형식입니다. 주의하세요.");
				break;
			case 525:
				Bukkit.broadcastMessage(ChatColor.YELLOW+"[ Tip ]");
			...
			case 675:
				...
				Bukkit.broadcastMessage("인간의 능력은 "+AbilityData.HUMAN_ABILITY_NUMBER+" 개 입니다.");
				Bukkit.broadcastMessage("DLC 능력은 "+AbilityData.HOBOT_ABILITY_NUMBER+" 개 입니다.");
				break;
			case 750:
				Bukkit.broadcastMessage(ChatColor.YELLOW+"[ Tip ]");
			...
			case 1350:
				Bukkit.broadcastMessage(ChatColor.YELLOW+"[ Tip ]");
				Bukkit.broadcastMessage("팁입니다 감사합니다");
				break;
			case 1425:
				Bukkit.broadcastMessage(ChatColor.YELLOW+"[ Tip ]");
			...
			case 1500:
				Bukkit.broadcastMessage(ChatColor.YELLOW+"[ Tip ]");
				Bukkit.broadcastMessage("오류가 많을 수 있습니다.");
				break;
			case 1575:
				Bukkit.broadcastMessage(ChatColor.YELLOW+"[ Tip ]");
				Bukkit.broadcastMessage("쉬어가는 시간입니다.");
				break;
			case 1650:
				Bukkit.broadcastMessage(ChatColor.YELLOW+"[ Tip ]");
			...
			case 1725:
				Bukkit.broadcastMessage(ChatColor.YELLOW+"[ Tip ]");
				Bukkit.broadcastMessage("원작자 : 칠각별");
				Bukkit.broadcastMessage("오픈 소스 : 플로리아");
				Bukkit.broadcastMessage("현 수정자 : 호봇");
				break;
			case 1800:
				Bukkit.broadcastMessage(ChatColor.YELLOW+"[ Tip ]");
				Bukkit.broadcastMessage("플러그인은 빼면 뺄수록 서버의 성능은 올라갑니다. 찡긋");
				break;
			case 1875:
				Bukkit.broadcastMessage(ChatColor.YELLOW+"[ Tip ]");
